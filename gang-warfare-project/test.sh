...
declare -A test_cases=( ["data/gw_04_02_00.dzn"]="12" ["data/gw_04_02_01.dzn"]="22" ["data/gw_06_05_01.dzn"]="unsat")

model_basename="gangwarfare" 
model="$model_basename.mzn"
output_fzn="$model_basename.fzn"
output_ozn="$model_basename.ozn"
compile_test="data/gw_31_42_00.dzn"
timelimit=2000
